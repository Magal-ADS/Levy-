...
<body class="bg-slate-100 font-sans text-slate-800 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="bg-slate-900 text-white w-64 flex-shrink-0 fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 z-30 flex flex-col shadow-2xl md:shadow-none">
        ...
        <nav id="sidebar-nav" class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="<?= htmlspecialchars(app_url()) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
            ...
            <a href="<?= htmlspecialchars(app_url('transacoes')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('contas-fixas')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group bg-slate-800/30">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('nova-conta')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('recebimentos')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('categorias')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('cartoes')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <a href="<?= htmlspecialchars(app_url('pessoas')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
            ...
            <div class="pt-6 pb-2 border-t border-slate-800 mt-4">
                <a href="<?= htmlspecialchars(app_url('configuracoes')) ?>" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                    <span class="flex items-center gap-3">
    ...
    <script>
        ...
        if ('serviceWorker' in navigator) {
            window.addEventListener('load', () => {
                navigator.serviceWorker.register('<?= htmlspecialchars(asset_url('sw.js')) ?>')
