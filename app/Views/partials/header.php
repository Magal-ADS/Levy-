...
<body class="bg-slate-100 font-sans text-slate-800 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="bg-slate-900 text-white w-64 flex-shrink-0 fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 z-30 flex flex-col shadow-2xl md:shadow-none">
        ...
        <nav id="sidebar-nav" class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
            ...
            <a href="/financeiro/public/index.php/solicitacoes" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                <span class="flex items-center gap-3">
                    <svg class="w-5 h-5 group-hover:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5-6l3 3-3 3"></path></svg>
                    Contas Encaminhadas
                </span>
            </a>
            ...
            <div class="pt-6 pb-2 border-t border-slate-800 mt-4">
                <a href="/financeiro/public/index.php/perfil" class="flex items-center px-4 py-3 text-slate-300 hover:bg-slate-800 hover:text-white rounded-lg transition-colors group">
                    <span class="flex items-center gap-3">
